...
bash ${CURR_DIR}/install_protobuf3.sh   3.5.1
bash ${CURR_DIR}/install_opencv.sh      3.4.16

bash ${CURR_DIR}/install_livox_sdk.sh 
bash ${CURR_DIR}/install_livox_ros_driver.sh      
